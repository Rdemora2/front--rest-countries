<template>
  <footer
    class="w-full flex justify-center items-center bg-blue text-white py-4"
  >
    <div class="flex items-center">
      <span class="text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl">
        2024 | Developed by
        <b class="text-green-400">Roberto de Moraes Zarzur</b>
      </span>
      <a
      ...
      <a
        href="https://www.linkedin.com/in/robertomoraeszarzur/"
        target="_blank"
        rel="noopener noreferrer"
        class="ml-3"
      >
